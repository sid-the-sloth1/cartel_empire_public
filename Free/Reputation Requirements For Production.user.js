...
// @match        https://cartelempire.online/production
// @match        https://cartelempire.online/university/3*
// @match        https://cartelempire.online/University/3*
// @grant        GM_addStyle
// @grant        GM_getValue
// @grant        GM_setValue
...
(function() {
  'use strict';
  let hasBusinessCourse = GM_getValue("hasBusinessCourse", false);
  
  let currentRep = 1000000;
  ...
  const metadata = {
    ...
    } else if (page.includes("/university/3")) {
      waitForElement(`#heading46`).then((element) => {
        if (element.querySelector("svg")) {
          GM_setValue("hasBusinessCourse", true);
        } else {
          GM_setValue("hasBusinessCourse", false);
        }
      });
    }
    //////
